...
class PostsItem2 extends Component {
      ...
      <div className={postClass}>
        ...
        <div className="posts-item-content">
          ...
          <div className="posts-item-meta">
            {post.user? <div className="posts-item-user"><Telescope.components.UsersAvatar user={post.user} size="large"/><Telescope.components.UsersName user={post.user}/></div> : null}
...
PostsItem2.contextTypes = {
  currentUser: React.PropTypes.object
};

module.exports = PostsItem2;
export default PostsItem2;
